        ...
        <div className="divide-y-2 divide-zinc-200 dark:divide-zinc-950">
          <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
            ...
            <div className="flex-1  flex flex-col gap-1">
              ...
              <div className="text-xxs text-zinc-400 dark:text-zinc-400 flex items-center gap-2">
                <span>Convite</span>
          ...
          <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
            ...
            <div className="flex self-center gap-1">
              <button className="h-8 w-8 flex rounded items-center justify-center bg-zinc-800 dark:bg-zinc-800 hover:bg-zinc-700 ">
